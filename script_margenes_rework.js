                        ...
                        <tr key={originalIndex} className="hover:bg-slate-50 transition-colors group">
                          ...
                          <td className="px-4 py-3 text-right bg-slate-50">
                            <input 
                              ...
                              className="w-24 text-right px-2 py-1 rounded bg-white border border-slate-200 focus:border-teal-500 focus:ring-1 focus:ring-teal-500 outline-none font-bold text-slate-800 shadow-sm"
                            />
                          </td>
                          <td className="px-4 py-3 text-right border-l border-slate-100">
                            <input 
                              ...
                              className="w-24 text-right px-2 py-1 rounded bg-indigo-50 border border-indigo-200 focus:border-indigo-500 focus:ring-1 focus:ring-indigo-500 outline-none font-bold text-indigo-700 shadow-sm"
                            />
                          </td>
                          <td className="px-4 py-3 text-right font-medium text-slate-500 border-l border-slate-100">
...
fs.writeFileSync('src/app/margenes/page.tsx', pageCode);
